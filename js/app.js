            ...
            !function(o, t) {
                ...
                var o = function() {
                    return (o = Object.assign || function(o) {
                        for (var t, e = 1, i = arguments.length; e < i; e++) for (var n in t = arguments[e]) Object.prototype.hasOwnProperty.call(t, n) && (o[n] = t[n]);
                        return o;
                ...
                return function() {
                    function i(t, i) {
                        var n = this;
                        this.core = t, this.$LG = i, this.core.getMediaContainerPosition = function() {
                            return {
                        ...
                        return this.core.settings = o(o({}, this.core.settings), s), this.settings = o(o(o({}, e), this.core.settings), s), 
                        this;
                    }
                    return i.prototype.toggleItemClass = function() {
                        for (var o = 0; o < this.core.items.length; o++) this.$LG(this.core.items[o]).toggleClass("lg-medium-zoom-item");
                        ...
                        })), this.toggleItemClass(), this.core.outer.on("click.lg.medium", (function() {
                            o.core.closeGallery();
                        })));
 ...
 */
    ...
    (() => {
        ...
        function menuInit() {
            ...
            if (document.querySelector(".filter-menu")) document.addEventListener("click", (function(e) {
                if (bodyLockStatus && e.target.closest(".filter-menu")) {
                    bodyLockToggle();
                    document.documentElement.classList.toggle("filter-menu-open");
                }
            }));
        }
        function menuClose() {
        ...
        function formFieldsInit(options = {
            ...
            document.body.addEventListener("focusin", (function(e) {
                ...
                if ("INPUT" === targetElement.tagName || "TEXTAREA" === targetElement.tagName) {
                    ...
                    if (!targetElement.hasAttribute("data-no-focus-classes")) {
                        ...
                        parentElement.classList.add("_form-focus");
                    }
            ...
            if (options.viewPass) document.addEventListener("click", (function(e) {
                ...
                if (targetElement.closest('[class*="__viewpass"]')) {
                    ...
                    let show = document.querySelector(".tabs-login-register__show-login");
                    let hide = document.querySelector(".tabs-login-register__hide-login");
                    let showRegister = document.querySelector(".tabs-login-register__show-register");
                    let hideRegister = document.querySelector(".tabs-login-register__hide-register");
                    targetElement.parentElement.classList.add("_form-focus");
                    targetElement.parentElement.querySelector("input").setAttribute("type", inputType);
                    show.classList.toggle("_viewpass-active");
                    hide.classList.toggle("_viewpass-active");
                    showRegister.classList.toggle("_viewpass-active");
                    hideRegister.classList.toggle("_viewpass-active");
                }
            }));
        ...
        function Autoplay(_ref) {
            ...
            function onTransitionEnd(e) {
                ...
                swiper.autoplay.paused = false;
                if (!swiper.autoplay.running) stop(); else if (0 === swiper.params.autoplay.delay && swiper.animating) swiper.once("transitionEnd", (() => {
                    run();
                })); else run();
            }
        ...
        function initSliders() {
            if (document.querySelector(".body-main__slider")) new core(".body-main__slider", {
            ...
            if (document.querySelector(".products-related__slider")) new core(".products-related__slider", {
            ...
            if (document.querySelector(".products-interested__slider")) new core(".products-interested__slider", {
                modules: [ Pagination, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 5,
                ...
                pagination: {
                    el: ".products-interested__swiper-pagination",
                    type: "bullets",
                    clickable: true
                },
                breakpoints: {
            ...
            if (document.querySelector(".product-gallery__slider")) new core(".product-gallery__slider", {
                modules: [ EffectCreative, Autoplay, Thumb, Zoom ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                spaceBetween: 0,
                ...
                thumbs: {
                    swiper: {
                        el: ".product-gallery__thumbs-slider",
                        slidesPerView: 4
                    }
                },
                on: {}
            });
            if (document.querySelector(".product-gallery__thumbs-slider")) new core(".product-gallery__thumbs-slider", {
                modules: [ Thumb ],
                direction: "vertical",
                slidesPerView: 4,
                spaceBetween: 16,
...
***************************************************************************** */
        ...
        var lg_medium_zoom_min = __webpack_require__(187);
        const galleries = document.querySelectorAll("[data-medium-zoom]");
        const thumbGalleries = document.querySelectorAll("[data-gallery]");
        if (galleries.length) {
            let galleryItems = [];
            galleries.forEach((gallery => {
                galleryItems.push({
                    ...
                    galleryClass: lightgallery_es5(gallery, {
                        plugins: [ lg_medium_zoom_min ],
                        licenseKey: "7EC452A9-0CFD441C-BD984C7C-17C8456E",
                        speed: 500,
                        selector: ".product-card__search"
                    })
                });
            }));
            flsModules.gallery = galleryItems;
        }
        if (thumbGalleries.length) {
            let thumbGalleryItems = [];
            thumbGalleries.forEach((thumbGallery => {
                thumbGalleryItems.push({
                    thumbGallery,
                    galleryClass: lightgallery_es5(thumbGallery, {
            ...
            flsModules.thumbGallery = thumbGalleryItems;
        }
        ...
        if (priceRangeFilter) {
            var lowerSlider = document.querySelector("#lower-price-thumb");
            var upperSlider = document.querySelector("#upper-price-thumb");
            document.querySelector("#high-price-value").value = upperSlider.value;
            document.querySelector("#low-price-value").value = lowerSlider.value;
            ...
            upperSlider.oninput = function() {
                ...
                document.querySelector("#high-price-value").value = this.value;
            };
            lowerSlider.oninput = function() {
                ...
                document.querySelector("#low-price-value").value = this.value;
            };
        }
        document.body.addEventListener("click", (function(e) {
            const targetElement = e.target;
            if (targetElement.closest(".categories-filter__item")) targetElement.parentElement.classList.toggle("_check-on");
        }));
        document.body.addEventListener("click", (function(e) {
            const targetElement = e.target;
            if (targetElement.closest(".item-product__cart-button")) targetElement.parentElement.parentElement.classList.add("_remove-product");
        }));
        window["FLS"] = true;
        isWebp();
        menuInit();
